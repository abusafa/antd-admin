...
import styles from './outlets-export-import-chart.less'
import {color} from '../../utils'
import {filter, sumBy,find} from 'lodash'
import {LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer} from 'recharts'
import numeral from 'numeral';

function OutletsExportImportChart (props) {
  const { data, select, inOut , title } = props
...
export default OutletsExportImportChart
